...
def evaluate(result_dir):
    ...
    messages.append('5 degree, 10cm: {:.4f}'.format(pose_aps[1, degree_05_idx, shift_10_idx]))
    ...
    messages.append('5 degree, 10cm: {:.4f}'.format(pose_aps[2, degree_05_idx, shift_10_idx]))
    ...
    messages.append('5 degree, 10cm: {:.4f}'.format(pose_aps[3, degree_05_idx, shift_10_idx]))
    ...
    messages.append('5 degree, 10cm: {:.4f}'.format(pose_aps[4, degree_05_idx, shift_10_idx]))
    ...
    messages.append('5 degree, 10cm: {:.4f}'.format(pose_aps[5, degree_05_idx, shift_10_idx]))
    ...
    messages.append('5 degree, 10cm: {:.4f}'.format(pose_aps[6, degree_05_idx, shift_10_idx]))
...
if __name__ == '__main__':
    ...
    result_dir = "/home/sjt/CenterSnap/results/eva_results/real_test_spd_all/"
