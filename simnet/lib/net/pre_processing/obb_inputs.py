...
def compute_abspose_field(poses, heat_maps, camera_model, threshold=0.3):
    ...
    for pose, ii in zip(poses, range(len(heat_maps))):
        ...
        abs_pose_values = np.array([
            ...
            rotation_matrix[1, 1], rotation_matrix[1, 2], rotation_matrix[2, 0],
            rotation_matrix[2, 1], rotation_matrix[2, 2], translation_vector[0], translation_vector[1],
            translation_vector[2], scale
        ])
